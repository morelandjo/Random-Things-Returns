...
public class GlobalChatDetectorBlockEntity extends BlockEntity implements ExtendedMenuProvider, Container {
    ...
    private final NonNullList<ItemStack> items = NonNullList.withSize(9, ItemStack.EMPTY); // 9 slots for ID Cards
    ...
    public boolean shouldConsumeMessage(String message, UUID playerUUID) {
        ...
        // Consume only if an ID card for this player is present in any of the 9 slots.
