...
public class DyeingMachineMenu extends AbstractContainerMenu {
    ...
    public DyeingMachineMenu(int containerId, Inventory playerInventory, FriendlyByteBuf buf) {
    ...
    public DyeingMachineMenu(int containerId, Inventory playerInventory, BlockPos pos) {
        ...
        this.addSlot(new Slot(this.blockEntity, DyeingMachineBlockEntity.SLOT_INPUT, 27, 22));
        this.addSlot(new Slot(this.blockEntity, DyeingMachineBlockEntity.SLOT_DYE, 76, 22) {
            @Override
            public boolean mayPlace(ItemStack stack) {
                return stack.getItem() instanceof DyeItem;
            }
        });
        this.addSlot(new Slot(this.blockEntity, DyeingMachineBlockEntity.SLOT_OUTPUT, 133, 22) {
            @Override
            public boolean mayPlace(ItemStack stack) {
                return false;
            }
