...
public class RainShieldBlock extends BaseEntityBlock {
    ...
    public static final MapCodec<RainShieldBlock> CODEC = simpleCodec(properties -> new RainShieldBlock());
    ...
    public void neighborChanged(BlockState state, Level level, BlockPos pos, Block neighborBlock, BlockPos neighborPos, boolean isMoving) {
        ...
        // Check if the block can still be placed
    ...
    public void animateTick(BlockState state, Level level, BlockPos pos, RandomSource random) {
        ...
        // Only show particles when raining AND the shield is active
        if (level.isRaining()) {
            // Check if the Rain Shield is active (not disabled by redstone)
            if (level.getBlockEntity(pos) instanceof RainShieldBlockEntity rainShield && rainShield.isActive()) {
                // Create visual effects when raining and active - flame and smoke particles in a spiral pattern
