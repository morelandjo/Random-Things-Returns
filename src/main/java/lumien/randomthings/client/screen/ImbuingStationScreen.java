...
/**
 * Mirrors upstream GuiImbuingStation: 176x208 background, animated bubble overlays around
 * the three ingredient slots and a horizontal progress arrow leading to the output slot.
 */
public class ImbuingStationScreen extends AbstractContainerScreen<ImbuingStationMenu> {

    private static final ResourceLocation BACKGROUND =
        ResourceLocation.fromNamespaceAndPath("randomthings", "textures/gui/imbuing_station.png");
    ...
    protected void renderBg(GuiGraphics gg, float partialTick, int mouseX, int mouseY) {
        ...
        // Horizontal progress arrow: source (189,13) -> dest (x+99, y+54), height 16, width scales 0..22.
