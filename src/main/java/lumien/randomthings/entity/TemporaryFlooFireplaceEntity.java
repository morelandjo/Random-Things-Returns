...
/**
 * Spawned when a Floo Token sits on the ground long enough. Acts as a temporary fireplace —
 * standing inside its bounding box and typing in chat is treated identically to standing on a
 * named Floo Brick. Lifetime is 260 ticks (~13s) per upstream EntityTemporaryFlooFireplace.
 */
public class TemporaryFlooFireplaceEntity extends Entity {
    ...
    private void spawnFlameGrid() {
        // Dense flame grid above the entity, matching upstream EntityTemporaryFlooFireplace#onUpdate.
