...
public class FlooFireplace {
    ...
    public CompoundTag toNbt() {
        ...
        // Store as an int-array sub-key under the same name we read back with.
    ...
    public static FlooFireplace fromNbt(CompoundTag tag) {
        ...
        // NbtUtils.readBlockPos(tag, "position") reads an IntArrayTag sub-key — symmetric to writeBlockPos.
