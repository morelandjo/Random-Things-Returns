...
public class ModItems {
    ...
    public static final Supplier<Item> SPECTRE_STRING = ITEMS.register("spectre_string",
        () -> new SpectreStringItem());

    public static final Supplier<Item> SPECTRE_ENERGY_INJECTOR = ITEMS.register("spectre_energy_injector",
        () -> new BlockItem(ModBlocks.SPECTRE_ENERGY_INJECTOR.get(), new Item.Properties()));

    // Spectre Coil Items (5 variants)
    public static final Supplier<Item> SPECTRE_COIL_NORMAL = ITEMS.register("spectre_coil_normal",
        () -> new BlockItem(ModBlocks.SPECTRE_COIL_NORMAL.get(), new Item.Properties()));

    public static final Supplier<Item> SPECTRE_COIL_REDSTONE = ITEMS.register("spectre_coil_redstone",
        () -> new BlockItem(ModBlocks.SPECTRE_COIL_REDSTONE.get(), new Item.Properties()));

    public static final Supplier<Item> SPECTRE_COIL_ENDER = ITEMS.register("spectre_coil_ender",
        () -> new BlockItem(ModBlocks.SPECTRE_COIL_ENDER.get(), new Item.Properties()));

    public static final Supplier<Item> SPECTRE_COIL_NUMBER = ITEMS.register("spectre_coil_number",
        () -> new BlockItem(ModBlocks.SPECTRE_COIL_NUMBER.get(), new Item.Properties()));

    public static final Supplier<Item> SPECTRE_COIL_GENESIS = ITEMS.register("spectre_coil_genesis",
        () -> new BlockItem(ModBlocks.SPECTRE_COIL_GENESIS.get(), new Item.Properties()));

    // Spectre Charger Items (4 tiers)
    public static final Supplier<Item> SPECTRE_CHARGER_NORMAL = ITEMS.register("spectre_charger_normal",
        () -> new SpectreChargerItem(SpectreChargerItem.Tier.NORMAL));

    public static final Supplier<Item> SPECTRE_CHARGER_REDSTONE = ITEMS.register("spectre_charger_redstone",
        () -> new SpectreChargerItem(SpectreChargerItem.Tier.REDSTONE));

    public static final Supplier<Item> SPECTRE_CHARGER_ENDER = ITEMS.register("spectre_charger_ender",
    ...
    // Weather Eggs
    public static final Supplier<Item> WEATHER_EGG_SUN = ITEMS.register("weather_egg_sun",
        () -> new WeatherEggItem(WeatherEggItem.WeatherType.SUN, new Item.Properties()));

    public static final Supplier<Item> WEATHER_EGG_RAIN = ITEMS.register("weather_egg_rain",
        () -> new WeatherEggItem(WeatherEggItem.WeatherType.RAIN, new Item.Properties()));
    ...
    public static final Supplier<CreativeModeTab> RT_CREATIVE_TAB = CREATIVE_MODE_TABS.register("randomthings", () -> CreativeModeTab.builder()
        ...
        .displayItems((parameters, output) -> {
            ...
            // Spectre Energy System
            output.accept(SPECTRE_STRING.get());
            output.accept(SPECTRE_ENERGY_INJECTOR.get());
            output.accept(SPECTRE_COIL_NORMAL.get());
            output.accept(SPECTRE_COIL_REDSTONE.get());
            output.accept(SPECTRE_COIL_ENDER.get());
            output.accept(SPECTRE_COIL_NUMBER.get());
            output.accept(SPECTRE_COIL_GENESIS.get());
            output.accept(SPECTRE_CHARGER_NORMAL.get());
            output.accept(SPECTRE_CHARGER_REDSTONE.get());
            output.accept(SPECTRE_CHARGER_ENDER.get());
            output.accept(SPECTRE_CHARGER_GENESIS.get());
