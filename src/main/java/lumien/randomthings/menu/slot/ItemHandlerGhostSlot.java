...
/**
 * A ghost slot that works with IItemHandler.
 * Items can be placed and removed, but operations work with copies.
 */
public class ItemHandlerGhostSlot extends Slot {
    ...
    public ItemHandlerGhostSlot(IItemHandler itemHandler, int index, int x, int y) {
